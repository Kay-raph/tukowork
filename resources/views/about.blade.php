...
"./logos/crm8.png" alt="Tuko Works"> 
	...
	<ul class="navbar-nav ml-auto"> 
		<li class="nav-item active"> 
			<li class="nav-item"> 
				<a href="/findlogin" class="login" click="active current='findlogin'"><i class="fa fa-fw fa fa-sign-in"></i>Sign In</a>
				<span class="sr-only">(current)</span>			   
			</li> 
			<li class="nav-item"> 
				<a href="/findsignup" class="signup" click="active current='signup'"><i class="fa fa-fw fa-user"></i>sign up</a>
			</li> 
			<li class="nav-item"> 
    ...
    <div class="container">
		...
		<p
		style="color: #000; font-size: 1.2em;">
		...
		<p style="color: #000; font-size: 1.2em;">Boldness,Innovation, Excellence, Unity, Integrity and Supremacy.</p>
    </div>
    <br>
    <footer id="footer" class="footer-1">
		...
		<li>
		<div class="thumb-content"><a href="policy.html">Our Policy</a></div>	
		</li>
		<li>	
		</li>
		<li>
