            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                       <figure> <lottie-player src="https://assets10.lottiefiles.com/packages/lf20_f755rjxp.json" mode="bounce" background="transparent"  speed="1" loop  autoplay></lottie-player> </figure>  
             <a href="{{ url('/postsignup') }}" class="signup-image-link">Create an account</a>
             
                    </div>
                   
                   
                    <div class="signin-form">
                        <h2 class="form-title">Sign in to Post Job</h2>
                        ...
                        <div class="social-login">
                            ...
                            <ul class="socials">
                                ...
                                <li><a href="index.html"><i id="customBtn"  class="display-flex-center zmdi zmdi-google"></i></a></li>
